...
MODEL_CONFIGS = {
    ...
    # ADD THIS: Configuration for the 3B victim
    "llama-3.2-3b": {
        "target_type": "huggingface",
...
async def main(attacker_model="gemma-3-27b", victim_model="gpt-4o", temperature=1.0, 
    ...
    # Disable converters for small Llama-3.2 models
    if victim_model in ["llama-3.2-1b", "llama-3.2-3b"]:
        converters = []  # No converters for small victims
